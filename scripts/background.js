...
var _this = this;
chrome.webNavigation.onBeforeNavigate.addListener(function (details) { return __awaiter(_this, void 0, void 0, function () {
    var b, hostname, pathname;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, chrome.storage.sync.get(['featureEnabled'])];
            case 1:
                b = _a.sent();
                if (!b.featureEnabled)
                    return [2 /*return*/];
                hostname = GetHostname(details.url);
                pathname = GetPathname(details.url);
